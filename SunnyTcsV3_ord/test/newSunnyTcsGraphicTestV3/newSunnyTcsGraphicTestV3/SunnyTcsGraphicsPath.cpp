#include "SunnyTcsGraphicsPath.h"
 ...
 const QColor SunnyTcsGraphicsPath::_ph_dash_color = QColor(100, 100, 120, 100);
...
SunnyTcsGraphicsPath::SunnyTcsGraphicsPath( const SunnyTcsMapAdjuster * ad, const SunnyTcsGraphicsPoint * start, const SunnyTcsGraphicsPoint * end, const SunnyTcsGraphicsPoint * ctrl)
	:SunnyTcsPath(ad->nextPhId()), SunnyTcsMapGraphicItem(), _ad(ad),_last_start(),_last_end(),_last_ctrl(),_arrow_start(),_arrow_end()
{
	Q_ASSERT(start && end);
	this->setStart(start);
	this->setEnd(end);
