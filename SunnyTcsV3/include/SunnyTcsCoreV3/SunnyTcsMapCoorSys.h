...
namespace core {
	...
	public:
		//静态数据
		static qint32 park_inaccuracy; //停车误差
		static qint32 running_inaccuracy; //跑车误差

		//tor
		A_SunnyTcsMapObject(qint32 id) :_id(id) {}
		A_SunnyTcsMapObject(const A_SunnyTcsMapObject& rhs) {
			_id = rhs._id;
		}
		virtual ~A_SunnyTcsMapObject() {}
		A_SunnyTcsMapObject& operator=(const A_SunnyTcsMapObject& rhs) { this->_id = rhs._id; return *this; }
		...
		virtual QVector<SunnyTcsMapBlock> getBlocks(qint32 resolution)const
		{
			return QVector<SunnyTcsMapBlock>();
		}
