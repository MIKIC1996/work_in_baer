...
namespace core {
	namespace logic {
		...
		std::shared_ptr<I_SunnyTcsCondition> SunnyTcsCoreLogicParser::parseLogicStr(QString str, QString & err) const
		{
			QString proto = str;
			qint32 counter = 0;
		...
		std::shared_ptr<I_SunnyTcsCondition> SunnyTcsCoreLogicParser::parseSingleConditionStr(QString str, QString & err) const
		{
			QRegExp exp1("\\[<\\w+>\\(.+\\)\\(.+\\)\\]");
			...
			while ((pos = exp3.indexIn(str, pos)) != -1) {
				...
				while (pos2 = exp4.indexIn(exp3.cap(0), pos2) != -1) {
					...
					switch (argType)
					{
					case basic::general::ARG_UNDEFINED:
						err = "";
						return nullptr;
						break;
					case basic::general::ARG_CHAR:
						err = "";
						return nullptr;
						break;
					case basic::general::ARG_BOOL:
						!isPrefixFinished ?
						...
						break;
					case basic::general::ARG_MIXED:
						err = "";
						return nullptr;
						break;
					case basic::general::ARG_INT8:
						!isPrefixFinished ?
					...
					case basic::general::ARG_UINT64:
						...
						break;
					case basic::general::ARG_QBYTEARRAY:
						err = "";
						return nullptr;
						break;
					case basic::general::ARG_QSTRING:
						err = "";
						return nullptr;
						break;
					default:
